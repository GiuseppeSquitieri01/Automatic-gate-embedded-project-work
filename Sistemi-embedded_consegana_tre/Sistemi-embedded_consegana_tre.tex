...
\begin{table}[H]
    \centering
    \resizebox{0.5\textwidth}{!}{ % Aggiungi questa riga
    \begin{tabular}{|c|c|}
    \hline
    \textbf{Test} & \textbf{Esito}  
    \\ \hline
    \texttt{Test 1} & \textcolor{green}{SUPERATO}  \\ \hline
    \texttt{Test 2} & \textcolor{green}{SUPERATO}  \\ \hline
    \texttt{Test 3} & \textcolor{green}{SUPERATO} \\ \hline
    \texttt{Test 4} & \textcolor{green}{SUPERATO}  \\ \hline
    \texttt{Test 5} & \textcolor{green}{SUPERATO} \\ \hline
    \texttt{Test 6} & \textcolor{green}{SUPERATO}  \\ \hline
    \texttt{Test 7} & \textcolor{green}{SUPERATO} \\ \hline
    \end{tabular}
    } % Chiudi \resizebox
    \caption{Variabili utilizzate nel modello Stateflow}
    \label{tab:variables}
