...
Questo caso d'uso, che modella US8, ha come attore il cancello, il quale chiude automaticamente il cancello dopo che è trascorso il tempo di lavoro.
    ...
    \end{figure}
\subsection{Chiusura automatica è [US8]}
Questo caso d'uso, che modella US8, ha come attore il cancello. Quando viene acceso, entra nella fase di chiusura se il sensore P2 non è attivo, ovvero se il cancello è aperto e il sensore P1 non è attivo.
    \begin{figure}[H]
        \centering
